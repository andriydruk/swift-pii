...
// version 2.5.148, which is what Presidio matches with. These are
...
public enum UnicodeTables {
    ...
    public static let sourceVersion = "2.5.148"


    /// `\w` -- UTS#18 word characters. `\b` is defined in terms of this.
    /// 796 ranges.
    public static let word: Table = [
        ...
        (0x2E2F, 0x2E2F), (0x3005, 0x3007), (0x3021, 0x302F), (0x3031, 0x3035),
        ...
        (0x1F170, 0x1F189), (0x1FBF0, 0x1FBF9), (0x20000, 0x2A6DF), (0x2A700, 0x2B739),
    ...
    /// `\s` -- whitespace.
    /// 10 ranges.
    public static let whitespace: Table = [
    ...
    @inlinable
    public static func isWord(_ s: Unicode.Scalar) -> Bool { contains(word, s) }
    @inlinable
    public static func isDigit(_ s: Unicode.Scalar) -> Bool { contains(digit, s) }
    @inlinable
    public static func isWhitespace(_ s: Unicode.Scalar) -> Bool { contains(whitespace, s) }
}
